...
towrite_long[0] = "______RANDOM________rubbISH______)(____&_________!______*___@________)_______#_________$______#_____\"____5+_"
...
while True:
	...
	if(counter!=0 and random.randint(0,4) > 2):
		hits += 1
