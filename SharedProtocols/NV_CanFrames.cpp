...
NV_CanFrames::NV_CANFrames(MCP_CAN& CANObj):CANObj(CANObj)
{
...
void NV_CanFrames::addItem(enum DataSource messageType, uint8_t terminatorStatus, float payload1)
{
	addItem_(messageType, terminatorStatus, payload1, 0, false);
}
void NV_CanFrames::addItem(enum DataSource messageType, uint8_t terminatorStatus, float payload1, float payload2)
{
