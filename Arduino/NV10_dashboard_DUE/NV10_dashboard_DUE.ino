...
void TaskCaptureButtons(void* pvParameters)
{
	...
	buttonCommand.ID = BT;
	peripheralStates[Lsig] = peripheralStates[Rsig] = peripheralStates[Horn] = peripheralStates[Wiper] = peripheralStates[Hazard] = STATE_DS;
	buttonCommand.data[0][Lsig] = buttonCommand.data[0][Rsig] = buttonCommand.data[0][Horn] = buttonCommand.data[0][Wiper] = buttonCommand.data[0][Hazard] = STATE_DS;
	const TickType_t delay = pdMS_TO_TICKS(100);
