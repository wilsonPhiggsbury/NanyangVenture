...
class Frames
{
	...
	// 1 frame for timestamp, other frames for floats, +Packet_DATAPOINTS frame for odd-number scenarios where one additional frame is needed for the lone float
