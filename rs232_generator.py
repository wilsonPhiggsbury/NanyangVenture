...
towrite_long[3] = "021.7C 028.9C 029.2C 032.4C 0.43B 52.9V 028.1C OP 41.5C 20 0214"
towrite_long[4] = "021.8C 028.9C 029.3C 032.5C 0.65B 52.9V 028.2C OP 41.5C 20 0214"
...
while True:
	...
	prepend = '>>' + str(random.randint(0,100)/10).zfill(4) + 'V ' + \
                  str(random.randint(0,20)/10).zfill(4) + 'A ' + str(random.randint(100,1000)).zfill(4) + 'W ' + str(random.randint(0,5000)).zfill(5) + 'Wh '
